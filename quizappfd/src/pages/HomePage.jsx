...
const HomePage = () => {
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Select the header directly. It's safe since this effect runs only for HomePage.
      const header = document.querySelector('.homepage-header');

      if (backToTopButton) { // Ensure button exists before trying to add/remove class
      ...
      if (header) { // Ensure header exists before trying to add/remove class
  ...
  return (
    // !!! IMPORTANT: New wrapper div for homepage-specific global-like styles !!!
    <div className="homepage-page-wrapper">
      <div className="homepage-container"> {/* This container holds the main content */}
